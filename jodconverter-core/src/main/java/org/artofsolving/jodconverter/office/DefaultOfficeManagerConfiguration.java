...
public class DefaultOfficeManagerConfiguration {
	...
	private final AtomicReference<ProcessManager> processManager = new AtomicReference<ProcessManager>(); // lazily initialised
	...
	public DefaultOfficeManagerConfiguration setProcessManager(final ProcessManager processManager) throws NullPointerException {
		...
		this.processManager.set(processManager);
		return this;
	}
	...
	public OfficeManager buildOfficeManager() throws IllegalStateException {
		...
		final ProcessManager processManager = getProcessManager();
	...
	public ProcessManager getProcessManager() {
		if (processManager.get() == null) {
			processManager.compareAndSet(null, findBestProcessManager());
		}
